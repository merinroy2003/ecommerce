...
const Navbar = () => {
  ...
  const navItems = [
    { title: "Fashion Apparel", path: "/" },
    { title: "Jewelry & Accessories", path: "/" },
    { title: "Footwear Collection", path: "/" },
    { title: "Handbags & Clutches", path: "/" },
    { title: "Sunglasses & Eyewear", path: "/" },
    { title: "Scarves & Wraps", path: "/" },
    { title: "Watches & Timepieces", path: "/" },
